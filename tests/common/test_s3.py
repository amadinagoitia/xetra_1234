...
#from E:\Sources\xetra_project\xetra_1234\xetra\common\\s3.py import S3BucketConnector
...
class TestS3BucketConnectorMethods(unittest.TestCase):
    ...
    print ("test 1 - for debugging pourposses")

    def test_list_files_in_prefix_wrong_prefix(self):
        """
        Test the list files_in_prefix method in case of a 
    ...
    print ("test 2 - for debugging pourposses")
